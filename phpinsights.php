...
return [
    ...
    */
    ...
    'remove' => [
        ...
        SlevomatCodingStandard\Sniffs\TypeHints\DisallowMixedTypeHintSniff::class, // array of mixed is the best we can do in the template engine
        SlevomatCodingStandard\Sniffs\Functions\FunctionLengthSniff::class, // phpstan reicht uns
        SlevomatCodingStandard\Sniffs\Variables\UnusedVariableSniff::class, // phpstan reicht
        PHP_CodeSniffer\Standards\Generic\Sniffs\PHP\CharacterBeforePHPOpeningTagSniff::class, // bei den templates nerft es
        SlevomatCodingStandard\Sniffs\Commenting\InlineDocCommentDeclarationSniff::class, // bei den templates nerft es
        //  ExampleInsight::class,
    ],
