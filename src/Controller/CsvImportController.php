...
class CsvImportController implements ControllerInterface
{
    private ?string $filename = null;

    public function __construct(
        readonly private EntityRepository       $entityRepository,
    ...
    public function process(): void
    {
        ...
        $imported = $this->fileToEntitysConverter->processFile($this->filename, $this->entityRepository);
